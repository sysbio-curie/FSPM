...
/**
 * Display list of edges improving score by opening edge
 * Sorted by decreasing kappa if not interrupted 
 * @author Daniel.Rovera@Curie.fr or @gmail.com
 */
public class OpeningEdgeTest extends AbstractCyAction{
	private static final long serialVersionUID = 1L;
	final public static String title="Test Score by Opening Edge";
	public OpeningEdgeTest(String section){
	...
	public void actionPerformed(ActionEvent e){
		...
		ComputeKappaOpenEdge ck=new ComputeKappaOpenEdge(applicationManager.getCurrentNetwork(),swingApplication.getJFrame());		
