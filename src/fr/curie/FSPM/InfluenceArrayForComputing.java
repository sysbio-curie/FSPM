 ...
 */
public class InfluenceArrayForComputing extends AbstractCyAction {	
	private static final long serialVersionUID = 1L;
	private CySwingAppAdapter adapter;
	final public static String title="Display Influence Array For Computing";
	private String format;	
	public InfluenceArrayForComputing(CySwingAppAdapter adapter){
