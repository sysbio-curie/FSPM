...
/**
 * Display list of edges improving score by setting weight to 0.0
 * Slight different from opening edge
...
public class NullWeightTest extends AbstractCyAction {	
	...
	public NullWeightTest(String section){
	...
	public void actionPerformed(ActionEvent e){
		...
		ComputeKappaNullWeight ck=new ComputeKappaNullWeight(applicationManager.getCurrentNetwork(),swingApplication.getJFrame());		
