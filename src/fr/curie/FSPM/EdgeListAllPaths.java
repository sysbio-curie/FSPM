 ...
 */
public class EdgeListAllPaths extends ActionPathTask{
	private static final long serialVersionUID = 1L;
	final public static String title="Edge List All Paths";
	public EdgeListAllPaths(String section){
	...
	public void actionPerformed(ActionEvent e){
		perform(title,ComputingThroughPath.EdgeListAll.class,false);
	}
}