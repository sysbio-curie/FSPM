...
/**
 * Display signed distance as list with open back edges
 * @author Daniel.Rovera@Curie.fr or @gmail.com
 */
public class SignedDistanceList extends ActionTreeTask{
	private static final long serialVersionUID = 1L;
	final public static String title="Signed Distance List";
	public SignedDistanceList(String section){
	...
	public void actionPerformed(ActionEvent e){
		perform(title,ComputingThroughTree.SignedDistancList.class);
	}
}