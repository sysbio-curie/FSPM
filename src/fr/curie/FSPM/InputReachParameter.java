...
public class InputReachParameter extends AbstractCyAction{
	...
	public InputReachParameter(String section){
	...
	public void actionPerformed(ActionEvent e){
		...
		ModelMenuUtils menuUtils = new ModelMenuUtils(new WeightGraphStructure(applicationManager.getCurrentNetwork()),swingApplication.getJFrame());
